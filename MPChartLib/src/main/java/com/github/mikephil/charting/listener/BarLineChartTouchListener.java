...
public class BarLineChartTouchListener extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<?
     ...
     * 触摸反馈器
     */
    private CombineTouchListener mCombineTouchListener;
    ...
    public boolean onTouch(View v, MotionEvent event, boolean notifyCombineListener) {

        if (mCombineTouchListener != null && notifyCombineListener) {
            mCombineTouchListener.onZoom(event);
        }
    ...
    public void setCombineTouchListener(CombineTouchListener combineTouchListener) {
        mCombineTouchListener = combineTouchListener;
    }
}
